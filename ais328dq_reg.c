...
int32_t ais328dq_acceleration_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  val[0] = (int16_t)(((uint8_t)buff[1] << 8) + buff[0]);
  val[1] = (int16_t)(((uint8_t)buff[3] << 8) + buff[2]);
  val[2] = (int16_t)(((uint8_t)buff[5] << 8) + buff[4]);
...
int32_t ais328dq_int1_dur_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    int1_duration.d = (uint8_t) (val & 0x7F);
...
int32_t ais328dq_int2_dur_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    int2_duration.d = (uint8_t) (val & 0x7F);
...
/**
  ...
  *
  */
int32_t ais328dq_int1_6d_threshold_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ais328dq_int1_ths_t int1_ths;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t ais328dq_int2_6d_threshold_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ais328dq_int2_ths_t int2_ths;
  int32_t ret;
